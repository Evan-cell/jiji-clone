...
function Navbar() {
  return (
    <div className='bg relative'>
      <div className='flex justify-between items-center border-b border-gray-400 relative'>
        <div className=''>
        ...
        <div className="absolute inset-x-0 bottom-0 h-1 bg-gray-600 opacity-10"></div>
      </div>
    </div>
  );
}
